...
# GCC's SH4A final compiler deliberately retains both the FPU and no-FPU
# multilibs.  Selecting -m4a-nofpu therefore adds a sysroot suffix, while
# Buildroot installs musl only once at the unsuffixed sysroot.  Point that
# multilib suffix at the same no-FPU musl installation.
ifeq ($(BR2_sh4aeb),y)
define HOST_GCC_FINAL_EXWORD_NOFPU_SYSROOT
	ln -snf . $(STAGING_DIR)/m4a-nofpu
endef
HOST_GCC_FINAL_POST_INSTALL_HOOKS += HOST_GCC_FINAL_EXWORD_NOFPU_SYSROOT
endif
