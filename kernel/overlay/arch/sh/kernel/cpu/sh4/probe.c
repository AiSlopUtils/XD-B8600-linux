...
void cpu_probe(void)
{
	...
	case 0x300b:
		...
		/*
		 * Casio's DATAPLUS 6 ASIC reports PRR 0x00002c00 (the
		 * extracted value here is 0xc0), while retaining the SH7724
		 * PVR and peripheral map.  Keep this alias board-specific so it
		 * cannot change probing on other SH-4A systems.
		 */
		case 0xc0:
#endif
		case 0x20:
